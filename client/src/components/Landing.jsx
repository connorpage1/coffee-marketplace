      ...
      <div className="hero-section">
        <Container textAlign="center">
          ...
          <p className="hero-subtitle">
            Discover the finest coffee beans and premium tea leaves sourced from
            around the world.
          </p>
        </Container>
      </div>
          ...
          <Grid columns={2} divided>
            <Grid.Row>
              <Grid.Column>
                ...
                <p>
                  Our coffee beans are sourced from the finest farms, offering a
                  rich and aromatic experience in every cup.
                </p>
              </Grid.Column>
              <Grid.Column>
                <Image
                  src="https://now.tufts.edu/sites/default/files/uploaded-assets/images/2022-04/150925_tea_shutterstock_1751704043_lg.jpg"
                  alt="Tea Leaves"
                  fluid
                />
                <Header as="h3">Exquisite Tea Leaves</Header>
                <p>
                  Enjoy a diverse selection of tea leaves, hand-picked for their
